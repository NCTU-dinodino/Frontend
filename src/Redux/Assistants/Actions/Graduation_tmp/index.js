...
export const fetchStudent = grade => dispatch => {
  ...
  axios.post('/_api/assistants/graduation/studentList', { grade }).then(res => {
    dispatch(store_student(res.data))
  })
  axios.post('/_api/assistants/graduation/studentList/download', { grade }).then(res => {
    // let data = res.data
    // let csvArr = []
    // csvArr.push([
    //   '學號',
...
export const setGradutateState = post_item => dispatch => {
  axios.post('/_api/assistants/graduation/check', post_item).then(res => {
